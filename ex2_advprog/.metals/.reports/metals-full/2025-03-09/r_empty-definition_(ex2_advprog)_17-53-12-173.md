error id: library/Binding.
file://<WORKSPACE>/src/main/scala/Library.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol library/Binding#
...
enum Binding:
    case Paperback, Mass_Market_Paperback, Hardcover, Kindle_Edition, ebook, Revised_Edition, Audible_Audio, Audio_CD, Audiobook, Unknown_Binding, None
